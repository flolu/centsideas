...
export const createReviewDone = createAction(
  `${PREFIX} ${CREATE} ${DONE}`,
  props<{ created: IReviewState }>(),
);
...
export const updateReviewDone = createAction(
  `${PREFIX} ${UPDATE} ${DONE}`,
  props<{ updated: IReviewState }>(),
);
...
export const publishReviewDone = createAction(
  `${PREFIX} ${PUBLISH} ${DONE}`,
  props<{ published: IReviewState }>(),
);
export const publishReviewFail = createAction(
  `${PREFIX} ${PUBLISH} ${FAIL}`,
  props<{ error: string }>(),
);
