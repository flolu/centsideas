...
export const authenticateDone = createAction(
...
export const confirmSignUpFail = createAction(
  `${PREFIX} ${CONFIRM_SIGN_UP} ${FAIL}`,
  props<{ error: string }>(),
);
...
export const updateUserDone = createAction(
  `${PREFIX} ${UPDATE} ${DONE}`,
