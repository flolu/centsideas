...
export const createIdeaDone = createAction(`${PREFIX} ${CREATE} ${DONE}`, props<{ created: IIdeaViewModel }>());
...
export const updateIdeaDone = createAction(`${PREFIX} ${UPDATE} ${DONE}`, props<{ updated: IIdeaViewModel }>());
...
export const publishIdeaDone = createAction(`${PREFIX} ${PUBLISH} ${DONE}`, props<{ published: IIdeaViewModel }>());
