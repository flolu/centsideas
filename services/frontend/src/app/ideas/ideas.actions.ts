...
export const getIdeasDone = createAction(
  `${PREFIX} ${GET} ${DONE}`,
  props<{ ideas: IIdeaViewModel[] }>(),
);
...
export const getIdeaByIdDone = createAction(
  `${PREFIX} ${GET_BY_ID} ${DONE}`,
  props<{ idea: IIdeaViewModel }>(),
);
export const getIdeaByIdFail = createAction(
  `${PREFIX} ${GET_BY_ID} ${FAIL}`,
  props<{ error: string }>(),
);
...
export const createIdeaDone = createAction(
  `${PREFIX} ${CREATE} ${DONE}`,
  props<{ created: IIdeaState }>(),
);
export const createIdeaFail = createAction(
  `${PREFIX} ${CREATE} ${FAIL}`,
  props<{ error: string }>(),
);
...
export const updateIdeaDone = createAction(
  `${PREFIX} ${UPDATE} ${DONE}`,
  props<{ updated: IIdeaState }>(),
);
export const updateIdeaFail = createAction(
  `${PREFIX} ${UPDATE} ${FAIL}`,
  props<{ error: string }>(),
);
