...
export const selectIdeaEntities = createSelector(AppSelectors.selectIdeasState, ideas.selectIdeaEntities);
export const selectIdea = (id: string) => createSelector(selectIdeaEntities, entities => entities[id]);
